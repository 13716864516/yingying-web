...
class CourseCopy extends NotORM {
    ...
    public function getAll($where) {
        ...
        $list=\PhalApi\DI()->notorm->course_copy
            ->select('id,uid')
            ->where($where)
            ->fetchAll();
    ...
    public function getDetail($where,$field='*') {
        ...
        $info=\PhalApi\DI()->notorm->course_copy
            ->select($field)
            ->where($where)
            ->fetchOne();
    ...
    public function upStar($where,$stars=1,$comments=1) {
        ...
        $rs=\PhalApi\DI()->notorm->course_copy
            ->where($where)
    ...
    public function getBuyAll($where=[]) {
        ...
        $info=\PhalApi\DI()->notorm->course_copy_users
    ...
    /* 排课记录 */
    public function getCourseCopyUsersList($p=1,$where=[],$order='id desc') {
    ...
    public function addBuy($data) {
        ...
        $rs=\PhalApi\DI()->notorm->course_copy_users
            ->insert($data);
